...
public class WeatherRepository {
    ...
    public void save(HistoryEntryEntity entity) {
        jpaRepository.save(entity);
    }
    
    public List<HistoryEntryEntity> findByCityAndDateRange(String city, LocalDate from, LocalDate to) {
    ...
    public List<HistoryEntryEntity> findAll() {
